...
export default function Header() {
  ...
  const showCollaborationButton =
    pathname.includes("/create-trip") || pathname.includes("/itinerary-options");
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          >
            {!isLoggedIn ? (
              ...
              <Link
                href="/logout"
                className="text-sm font-medium bg-gradient-to-r from-red-600 to-red-500 text-white px-6 py-2.5 rounded-full hover:shadow-md hover:from-red-700 hover:to-red-600 transition-all duration-300 shadow-sm"
              >
                Log Out
              </Link>
            )}
